...
class _InstitutionDialogState extends State<InstitutionDialog> {
  ...
  void initState() {
    super.initState();
    institution = widget.institution == null
        ? Institution(name: widget.name)
        : widget.institution;
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: TextField(
              controller:
                  TextEditingController(text: institution.contactInformation),
              decoration: new InputDecoration(
                border: new OutlineInputBorder(
                    borderSide: new BorderSide(color: Colors.teal)),
              ),
              ...
              RoundedButtonWidget(
                onPressed: () async {
                  ...
                  if (institution != null) {
                    ...
                    await widget.ks
                        .editInstitution(EditingTypEnum.UPDATE, institution);
                  } else {
                    await widget.ks
                        .editInstitution(EditingTypEnum.CREATE, institution);
                  }
